...
plt.plot(Stats_one_arr_vre_sats[0],Stats_one_arr_vre_sats[1],color='b',\
            label='v_re satellites')
fb = plt.fill_between(Stats_one_arr_vre_sats[0],Stats_one_arr_vre_sats[1]+\
                 Stats_one_arr_vre_sats[2],Stats_one_arr_vre_sats[1]-\
                 Stats_one_arr_vre_sats[2],color='b',alpha=0.4,edgecolor='k',\
                 linewidth=2)
fb.set_edgecolor('k')
plt.xlabel(r'$log_{10}\ R_{e}\ $[kpc]')
plt.ylabel(r'$log_{10}\ v\ $[km/s]')
...
plt.plot(Stats_one_arr_vre_cens[0],Stats_one_arr_vre_cens[1],color='r',\
            label='v_re centrals')
fb = plt.fill_between(Stats_one_arr_vre_cens[0],Stats_one_arr_vre_cens[1]+\
                 Stats_one_arr_vre_cens[2],Stats_one_arr_vre_cens[1]-\
                 Stats_one_arr_vre_cens[2],color='r',alpha=0.4,edgecolor='k',\
                 linewidth=2)
fb.set_edgecolor('k')
plt.xlabel(r'$log_{10}\ R_{e}\ $[kpc]')
plt.ylabel(r'$log_{10}\ v\ $[km/s]')
